...
const VOLUNTEERS = [
  { name: 'Анна Сергеевна', role: 'Руководитель проекта', emoji: '👩‍💼', desc: 'Координация, взаимодействие с администрацией.' },
  { name: 'Дмитрий Иванов', role: 'Ветеринарный куратор', emoji: '🩺', desc: 'Организация осмотров и лечения животных.' },
  { name: 'Марина Козлова', role: 'Координатор приюта', emoji: '🏠', desc: 'Уход за животными, ведение документации.' },
  { name: 'Алексей Петров', role: 'Волонтёр-водитель', emoji: '🚗', desc: 'Транспортировка животных, помощь в отлове.' },
];
